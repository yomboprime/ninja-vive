...
THREE.ViveHydraController = function ( id ) {
	...
	function pollRazerHydra( hydraController ) {
		...
		if ( hydraController ) {
			...
			// Joystick left
			dummyHydraGamepad.buttons[ 4 ].pressed = hydraController.buttons[ id0 ? 8 : 8 + 12 ].pressed;
			// Joystick right
			dummyHydraGamepad.buttons[ 5 ].pressed = hydraController.buttons[ id0 ? 9 : 9 + 12 ].pressed;
			// Joystick up
			dummyHydraGamepad.buttons[ 6 ].pressed = hydraController.buttons[ id0 ? 10 : 10 + 12 ].pressed;
			// Joystick down
			dummyHydraGamepad.buttons[ 7 ].pressed = hydraController.buttons[ id0 ? 11 : 11 + 12 ].pressed;
